...
const skills = [
  ...
  { icon: SiJavascript, name: 'JavaScript', level: 78 },
  { icon: SiMysql, name: 'MySQL', level: 80 },
  { icon: SiOpencv, name: 'OpenCV', level: 82 },
  { icon: SiGithub, name: 'Git & GitHub', level: 85 },
  { icon: SiTailwindcss, name: 'Tailwind CSS', level: 75 },

  { icon: SiPandas, name: 'Pandas', level: 80 },
  { icon: SiNumpy, name: 'NumPy', level: 78 },
  { icon: SiPlotly, name: 'Matplotlib', level: 75 },
  { icon: SiC, name: 'C Programming', level: 72 },
  { icon: SiBootstrap, name: 'Bootstrap', level: 78 },
      ...
      <div className="container mx-auto max-w-6xl">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative w-80 h-80 mx-auto lg:mx-0">
              ...
              <div className="relative w-full h-full glass rounded-full p-2 hover:shadow-glow-primary transition-all duration-500 group">
                <div className="w-full h-full cursor-pointer rounded-full overflow-hidden bg-gradient-secondary">
                  <img src="/Images/ProfileLogo.jpeg" alt="Sejal Hadole - Python Developer" className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" />
                </div>
              </div>
          ...
          <div ref={contentRef} className="space-y-6">
            ...
            I am an MCA student and aspiring Python Developer with hands-on experience in Django, AI/ML, OpenCV and YOLOv8. I enjoy building backend systems, computer vision applications and real-world web projects.           
            </p>

            <p className="text-lg text-muted-foreground leading-relaxed">
            My skill set includes Python, Django, SQL, Machine Learning, OpenCV and Data Analysis. I am passionate about solving real-world problems through technology and continuously learning modern development tools and AI technologies.            
            </p>
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              ...
              <div className="glass px-4 py-2 rounded-lg">
                <span className="text-accent-glow font-medium"></span>
                <span className="text-muted-foreground ml-1">Quick Learner</span>
              </div>
            </div>
          </div>
        </div>
