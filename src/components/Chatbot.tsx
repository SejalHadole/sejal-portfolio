...
reply = "Sejal specializes in Python Development, Full Stack Development, AI/ML, Machine Learning, and modern web application development.";

} else if (userInput.includes("contact")) {
reply = "You can contact Sejal through the contact form or email at [sejalhadole2003@gmail.com](mailto:sejalhadole2003@gmail.com).";

} else if (
userInput.includes("react") ||
userInput.includes("gsap")
) {
reply = "Sejal uses React, GSAP, JavaScript, and modern frontend technologies to build responsive and interactive user interfaces.";

} else if (userInput.includes("project")) {
reply = "Sejal has developed projects like Quick Bid, KLAP AI Learning System, SolarSquare CRM, Speech Text Reader, and AttendPro.";

} else if (userInput.includes("skills")) {
reply = "Sejal's skills include Python, Django, React, JavaScript, Machine Learning, OpenCV, YOLOv8, MySQL, SQL, HTML, CSS, and REST APIs.";

} else if (
userInput.includes("internship") ||
userInput.includes("job")
) {
reply = "Sejal is currently looking for internship and entry-level opportunities in Python Development, Full Stack Development, and AI/ML.";

} else if (
userInput.includes("resume") ||
userInput.includes("cv")
) {
reply = "You can download Sejal's resume from the Resume button available in the portfolio.";

} else if (
userInput.includes("certificate") ||
userInput.includes("certification")
) {
reply = "Sejal has completed certifications in GitHub Copilot, Microsoft AI Skills Challenge, Python Development, and AI/ML technologies.";

} else {
reply = "I can help you with projects, skills, certifications, internships, resume, and contact details.";
}
