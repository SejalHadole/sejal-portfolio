    ...
    <section id="contact" ref={sectionRef} className="py-20 px-6 relative overflow-hidden">
      <div className="container mx-auto max-w-6xl">
        <div ref={titleRef} className="text-center mb-16">
          ...
          I’m always open to discussing internships, collaborations, AI/ML projects,
          full stack development opportunities, and innovative software solutions.
          Feel free to connect with me anytime.          </p>
        </div>
      ...
      I'm a Python Developer passionate about web development, machine learning,
      and building real-world projects. I enjoy working with technologies like
      Django, OpenCV, MySQL, and JavaScript to create scalable and user-friendly
      applications. I'm always open to internship opportunities, collaborations,
      and exciting tech projects.
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">sejalhadole2003@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-secondary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">+91 9373159640</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 p-4 glass rounded-lg hover:shadow-glow-primary transition-all duration-300">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">Akot, Maharashtra, India</p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/SejalHadole"
                  target="_blank"
...
>
                ...
                <a
                href="https://www.linkedin.com/in/sejal-hadole-a9193b335?"
                target="_blank"
                rel="noopener noreferrer"
