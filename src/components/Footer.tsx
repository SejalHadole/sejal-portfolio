      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div>
            ...
            Building innovative and user-friendly applications using Python, Django, Machine Learning, and modern web technologies while focusing on clean code, scalability, and real-world problem solving.            
            </p>
          ...
          <a
            href="https://linkedin.com/in/sejal-hadole-a9193b335"
            target="_blank"
            rel="noopener noreferrer"
        ...
        <div className="border-t border-border/30 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-muted-foreground text-center md:text-left">
            © 2026 SejalHadole. All rights reserved.
          </p>
