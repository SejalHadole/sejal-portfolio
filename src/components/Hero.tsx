...
const Hero = () => {
  ...
  const downloadCV = () => {
    ...
    link.href = '/Images/Sejal_Hadole_Resume.pdf';    
    link.download = 'Sejal_Hadole_Resume.pdf';    document.body.appendChild(link);
    link.click();
    ...
    <section id="hero" ref={heroRef} className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <h1 ref={titleRef} className="text-4xl md:text-6xl lg:text-7xl font-light text-foreground mb-6 leading-tight">
          ...
          <span className="text-primary-glow">Python Developer</span>
        </h1>

      <p ref={subtitleRef} className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto leading-relaxed">
  Python Developer | Django | AI/ML | OpenCV | YOLOv8
  <br />
  MCA student passionate about backend development, AI/ML and computer vision technologies with hands-on experience in Django, OpenCV and YOLOv8 projects.
</p>
